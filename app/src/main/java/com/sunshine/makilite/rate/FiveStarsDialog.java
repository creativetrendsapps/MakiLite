...
public class FiveStarsDialog  implements DialogInterface.OnClickListener{
    ...
    private final static int DEFAULT_POSITIVE = R.string.ok;
    private final static int DEFAULT_NEGATIVE = R.string.go_pro_hint;
    private final static int DEFAULT_NEVER = R.string.never;
