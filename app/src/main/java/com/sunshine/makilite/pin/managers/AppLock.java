...
public abstract class AppLock {
     ...
     */
    public static final long DEFAULT_TIMEOUT = 3000 * 30; // 10sec
     ...
     * Set in {@link LifeCycleInterface#onActivityPaused(Activity)}
     * and {@link LifeCycleInterface#onActivityResumed(Activity)}
     */
