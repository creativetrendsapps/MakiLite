...
public class QuickVK extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.md_blue_500, R.color.md_blue_500, R.color.md_blue_500);
        ...
        String webViewUrl = "https://m.vk.com/";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (Uri.parse(url).getHost().endsWith("vk.com")
                        || Uri.parse(url).getHost().endsWith("m.vk.com")) {
                    return false;
                }
