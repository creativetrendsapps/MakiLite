...
public class QuickTwitter extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.md_light_blue_A700, R.color.md_light_blue_A700, R.color.md_light_blue_A700);
        ...
        String webViewUrl = "https://m.twitter.com/";
